...
<div class="ibox-content">
	<div id="actionMessages" tabindex='1'></div>
		...
		<div id="uploadpre0">
		<div class="dr-name-fields">
		<input class="form-control" type="text" name="question[]" id="question-0" value="" placeholder="Add Question" required="">
		</div>
		</div>
		<?php } ?>
		</div>
		<div class="add-btn">
		<span class="btn pull-left changeidss" id="0" onclick="return add_form_field(this.id)">+ Add Question</span>
		</div>
		</div>
		</div>
		</div>
...
$("#addRemTime").click(function(){
	if(idCounter < 4)
	{
		...
		var str =	'<div class="row extraTimers">';
			str+= '<div class="col-md-12"><div class="col-md-4" id="remTime_'+subIdCounterVal+'">';
