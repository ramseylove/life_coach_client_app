...
<div class="ibox-content">
	<div id="actionMessages" tabindex='1'></div>
		...
		?>
		<input type="hidden" name="nextweek" class="nextweek" value="1">
...
$("#addRemTime").click(function(){
	if(idCounter < 4)
	{
		...
		var str =	'<div class="row extraTimers">';
			str+= '<div class="col-md-12"><div class="col-md-4" class="remTime_'+subIdCounterVal+'">';
			str+=	'	<div class="form-group">';
			str+=	'		<div class="input-group" data-autoclose="true">';
			str+=	'			<input type="text" readonly class="form-control format_'+subIdCounterVal+'" name="remTime_'+subIdCounterVal+'" id="remTime_'+subIdCounterVal+'" value="<?php echo date("H:i");?>">';
