...
var StartYear = 1975; //First Year in drop down year selection
...
var WeekHeadColor = "#cc0033";//var WeekHeadColor="#18861B";//Background Color in Week header.
...
var HoverColor = "#6C89C3"; //color when mouse move over.
var DisableColor = "#999966"; //color of disabled cell.
var ThemeBg = "";//Background image of Calendar window.
var CalBgColor = "#808080";//Background color of Calendar window.
var PrecedeZero = true;//Preceding zero [true|false]
var MondayFirstDay = true;//true:Use Monday as first day; false:Sunday as first day. [true|false]  //added in version 1.7
var UseImageFiles = true;//Use image files with "arrows" and "close" button
var DisableBeforeToday = true; //Make date before today unclickable.
var imageFilesPath = "http://localhost/uniquetravels/assets/common/images";
...
function RenderCssCal(bNewCal)
{
	...
	for (i = 0; i < 7; i += 1)
	{
		vCalHeader += "<td width='" + CellWidth + "px' class='calTD'><font  color='#cc3300' ><b>" + WeekDayName[i].substr(0, WeekChar) + "</b></font></td>\n";
	}
	...
	else //if not to show time.
	{
	    ...
	    //close button
	    if (UseImageFiles) {
	        vCalClosing += "<img onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\"); stopSpin();' src='http://localhost/uniquetravels/assets/common/images/delete.jpg' width='20px' height='17px' title='Close Calender' onmouseover='changeBorder(this,0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>";
	    }
	    else {
	...
	funcCalback += "}\n winCal.style.visibility='hidden';\n (($('#totalDays').val()!=undefined)?leaveToDate($('#totalDays').val(),$('#fromDate').val()):'');\n}\n";
	...
	if (!winCal)
	{
		...
		cssStr = ".calTD {font-family: verdana; font-size: 12px; text-align: center; border:0; background-color:orange;}\n";
		//cssStr+= ".calR {font-family: verdana; font-size: 12px; text-align: center; font-weight: bold; color: red;}"
		cssStr += ".calR {font-family: verdana; font-size: 12px; text-align: center; font-weight: bold;background-color:#6C89C3;}";
