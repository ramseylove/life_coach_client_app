...
var HoverColor = "#FFFFFF"; //color when mouse move over.
...
var imageFilesPath = "http://www.quagnitia.com/demo/jobs4-me/images/date";
...
function RenderCssCal(bNewCal)
{
	...
	else //if not to show time.
	{
	    ...
	    //close button
	    if (UseImageFiles) {
	        vCalClosing += "<img onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\"); stopSpin();' src='http://www.quagnitia.com/demo/jobs4-me/images/date/cal_close.gif' width='16px' height='14px' onmouseover='changeBorder(this,0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>";
	    }
	    else {
